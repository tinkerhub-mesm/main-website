    ...
    //  console.log(data);
      var row = table.insertRow(i+1);
        ...
        var cell2 = row.insertCell(1);
          ...
          cell1.innerHTML = i+1;
          cell2.innerHTML = promisedData[i].data.email;
          cell3.innerHTML = promisedData[i].data.email;
          cell4.innerHTML = promisedData[i].data.adminStatus;
          // demo to view id of the datas
          cell5.innerHTML = promisedData[i].id;
          cell6.innerHTML = promisedData[i].data.academics;
...
//    email: document.getElementById('WeeklyChallenges_desc').value,
//    adminStatus: '0',
//    academics: document.getElementById('WeeklyChallenges_rules').value,
//    imgUrl: imgurl,
//  };
//  writeData({
//    collection: 'users',
...
//  }).then((promisedData) =>{
  //  loading_animations_disable();
    // Reloading page when update function is done
  //window.location.href = "students_details.html";
  //});

  function studentsData(imgurl) {
...
studentsData(imgurl).then((promisedData) =>{
  loading_animations_disable();
    // Reloading page when update function is done
  window.location.href = "students_details.html";
});
